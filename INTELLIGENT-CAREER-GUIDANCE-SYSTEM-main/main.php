						...
						<div class="col-md-8">
							...
							<?php
								...
								if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true):?>
									...
									<a class="main-button icon-button" href="chatbot.php">Get Started!</a>
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome to EmpowerED</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">EmpowerED</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
					...
					<div class="col-md-4">
						<div class="feature">
							...
							<div class="feature-content">
								...
								// Check if the user is logged in, if not then redirect him to login page
								if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true):?>
									<a href="chatbot.php"><h4>AI Career Counselling</h4></a>
								<?php else: ?>
									<a href="http://127.0.0.1:5000/"><h4>AI Career Counselling</h4></a>
									
								
							<?php endif ?>
								
								<p>Take the test to find the perfect role for you after whichever grade you like.</p>
							</div>
						</div>
					</div>
					<!-- /feature -->
